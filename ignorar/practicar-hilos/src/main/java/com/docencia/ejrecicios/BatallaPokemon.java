package com.docencia.ejrecicios;
...
public class BatallaPokemon {
    ...
    private void atacar(String atacante, boolean esPikachu) {
        ...
        if (esPikachu) {
            hpCharmander -= danio;
            System.out.println(atacante + " ataca con " + danio + " de daño. HP rival: " + hpCharmander);
            ...
            hpPikachu -= danio;
            System.out.println(atacante + " ataca con " + danio + " de daño. HP rival: " + hpPikachu);
