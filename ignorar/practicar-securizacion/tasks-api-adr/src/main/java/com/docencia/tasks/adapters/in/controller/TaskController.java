 ...
 * La seguridad de estos endpoints esta centralizada en 'SecurityConfig.java'.
 * 
 * Reglas aplicadas (ver SecurityConfig):
 * - GET: Permitido para roles USER y ADMIN.
 * - POST, PATCH, DELETE: Solo permitido para rol ADMIN.
 */
